...
export const Covid = () => {
    ...
    return (
        <div>
            <center>
                <h1 className="bg-danger p-2" style={{ color: "black" }}>Covid App</h1>
            </center>

            <div className="container">
                <center>

                    <select style={{ color: "black", width: "50%" }} className="bg-danger fs-4 mt-3 p-2" name="" id="" onChange={onSelectChange}>
